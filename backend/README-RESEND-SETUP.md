...
### Admin-E-Mails
Das Admin-Panel kann E-Mails manuell verschicken. Dafür muss der Benutzer im Firebase-Login angemeldet sein. Das Backend prüft das Firebase-ID-Token serverseitig; eine zusätzliche `ADMIN_EMAILS`-Umgebungsvariable ist nicht erforderlich.
